...
// проверяем наличие данных в чекбоксе и сохраняем их
  $access_eight = '';
    if (empty($_POST["access_eight"]))
    {
       $access_eight = "Согласие на обработку персональных данных";
    }
    elseif (!empty($_POST["access_eight"]) && is_array($_POST["access_eight"]))
    {
       $access_eight = implode(" ", $_POST["access_eight"]);
    }
...
// Формирование тела письма
  ...
  $msg .= "<p><strong>Сообщение с пометкой:<br/> </strong> ".$access_eight."</p>\r\n";
  $msg .= "</body></html>";
 // отправка сообщения
