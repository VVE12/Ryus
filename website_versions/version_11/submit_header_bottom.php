...
// проверяем наличие данных в чекбоксе и сохраняем их
  $access_header_bottom = '';
    if (empty($_POST["access_header_bottom"]))
    {
       $access_header_bottom = "Согласие на обработку персональных данных";
    }
    elseif (!empty($_POST["access_header_bottom"]) && is_array($_POST["access_header_bottom"]))
    {
       $access_header_bottom = implode(" ", $_POST["access_header_bottom"]);
    }
...
// Формирование тела письма
  ...
  $msg .= "<p><strong>Сообщение с пометкой:<br/> </strong> ".$access_header_bottom."</p>\r\n";
  $msg .= "</body></html>";
 // отправка сообщения
